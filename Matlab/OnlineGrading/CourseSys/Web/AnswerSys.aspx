<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AnswerSys.aspx.cs" Inherits="StuSys" %>
...
<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
     ...
     <asp:TemplateColumn HeaderText="My Answer">
      <ItemTemplate>
       <asp:Label id=Label3 runat="server" width=560px Text='<%# DataBinder.Eval(Container, "DataItem.answer") %>'>
       </asp:Label>
      </ItemTemplate>
      <FooterTemplate>
       <asp:LinkButton ID="lb_commit" runat="server" CommandName="CommitAll">Commit All</asp:LinkButton>
       </FooterTemplate>
      <EditItemTemplate> 
       <asp:TextBox id="TextBox1"  TextMode =MultiLine  Height=80px runat="server" Width=560px  Text='<%# DataBinder.Eval(Container, "DataItem.answer")%>'></asp:TextBox>
      </EditItemTemplate>
     </asp:TemplateColumn>

     <asp:EditCommandColumn ButtonType="PushButton" UpdateText="更新" HeaderText="Submit" CancelText="取消" EditText="Submit">
