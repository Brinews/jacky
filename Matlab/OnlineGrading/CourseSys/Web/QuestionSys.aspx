<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionSys.aspx.cs" Inherits="StuSys" %>
...
<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <FooterTemplate>
       <asp:LinkButton id="LinkButton1" runat="server" CommandName="Insert">Add Question</asp:LinkButton>
         </FooterTemplate>
     ...
     <asp:TemplateColumn HeaderText="AssignID">
      <ItemTemplate>
       <asp:Label id=Label3 runat="server" width=40px Text='<%# DataBinder.Eval(Container, "DataItem.asgn_id") %>'>
       </asp:Label>
      </ItemTemplate>
      <FooterTemplate> </FooterTemplate>
      <EditItemTemplate> </EditItemTemplate>
     ...
     <asp:TemplateColumn HeaderText="Question Content">
      ...
      <FooterTemplate>
       <asp:TextBox id="TextBox2" TextMode=MultiLine Width=560px Height=80px  runat="server"></asp:TextBox>
      </FooterTemplate>
      <EditItemTemplate>
       <asp:TextBox id="TextBox1"  TextMode =MultiLine  Height=80px runat="server" Width=560px  Text='<%# DataBinder.Eval(Container, "DataItem.content")%>'></asp:TextBox>
       </EditItemTemplate>
     </asp:TemplateColumn>
