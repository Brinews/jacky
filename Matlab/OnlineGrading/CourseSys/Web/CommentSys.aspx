<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommentSys.aspx.cs" Inherits="StuSys" %>
...
<asp:datagrid id="DataGrid1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
     ...
     <asp:TemplateColumn HeaderText="Student's Answer">
      <ItemTemplate>
       <asp:Label id=Label3 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.answer") %>'>
       </asp:Label>
      </ItemTemplate>
      <FooterTemplate>
       </FooterTemplate>
      <EditItemTemplate> 
       <asp:Label id=Label13 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.answer") %>'>
        ...
        <asp:TemplateColumn HeaderText="Teacher's View">
            <ItemTemplate>
       <asp:Label id=Label23 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.review") %>'>
       </asp:Label>
      </ItemTemplate>
      <FooterTemplate>
       </FooterTemplate>
      <EditItemTemplate> 
       <asp:TextBox id="TextBox1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.review") %>'>
       </asp:TextBox>
      </EditItemTemplate>
     </asp:TemplateColumn>

      <asp:EditCommandColumn ButtonType="PushButton" UpdateText="Update" HeaderText="" CancelText="Cancel"
                EditText="Review"></asp:EditCommandColumn>
