...
public partial class StuSys : System.Web.UI.Page
{
    ...
    protected void DataGrid1_UpdateCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        TextBox review = (TextBox)e.Item.FindControl("textbox1");

        myControl.UpdateDataBase("update [Answers] set [review]='" + review.Text + "' where [stu_id]='" + stuId + "' and [question_id]='"+id+"'");
        myControl.CloseConnection();
