 ...
 * 4.Ask the server how long the server has been running fro and receive the correct
 * response.
 * 5.Ask the server how long the client has been in the chat room fro and receive the
 * correct response.
...
public class ClientInstance implements Runnable {
	...
	class ClientHandler extends Thread {
		private static final String SERVER_HEAD_MSG = "Server:";
		...
		public void printMessage(String message) {
			String msg = "";
			int index = message.indexOf("_Server:");
			if (index >= 0) {
