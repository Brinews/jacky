...
public class xiugai extends JInternalFrame {
    ...
    private void initComponents() {
                    ...
                    try{
                        if(database.query(sql)){//此处用了个database.executeSQL(sql)提示resultset 关闭
                            if(!database.rs.first()) {
                                ...
                                jtf8.setText(database.rs.getString("出生年月"));
                                jtf9.setText(database.rs.getString("籍贯"));
                                jtf10.setText(database.rs.getString("家庭住址"));
                                jtf11.setText(database.rs.getString("本校住址"));
                                jtf12.setText(database.rs.getString("个人联系电话"));
                                jtf13.setText(database.rs.getString("家庭联系电话"));
        ...
        butOk.addActionListener(new ActionListener(){
            ...
            jtf9.getText()+"',家庭住址='"+ 
            jtf10.getText()+"',本校住址='"+ 
            jtf11.getText()+"',个人联系电话='"+ 
            jtf12.getText()+"',家庭联系电话='"+ 
            jtf13.getText()+"'"+ 
            " where 学号='"+jtf1.getText()+"'";
            try{
