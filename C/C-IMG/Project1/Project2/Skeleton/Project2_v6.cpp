...
ModelView planet[6] = {PaintSphere, PaintSun, PaintVenus,
 						PaintMars, PaintEarth, PaintMoon};
...
{
	int i;
	// Clear the window color before Painting is performed
