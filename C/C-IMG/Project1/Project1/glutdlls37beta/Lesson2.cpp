...
case WM_LBUTTONDOWN:
       {
chakela=1;
//   amd[LOWORD(lParam)/10][HIWORD(lParam)/10]=1;
//MessageBox(0,"cvxcv","fgfd",2);
return 0;
    }
...
while(y<200)
     {
       ...
       glTranslatef(x,-y,-200.0f);   
	    glColor3f(rmd[x][y]/50.0f,gmd[x][y]/50.0f,bmd[x][y]/50.0f); 
