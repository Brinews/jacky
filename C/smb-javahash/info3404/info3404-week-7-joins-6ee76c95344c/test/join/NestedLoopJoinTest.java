...
public class NestedLoopJoinTest {
    ...
    public void constructorBuster() throws Exception {
        ...
        AccessIterator results = new NestedLoopJoin(new ConstructorBuster(), new ConstructorBuster(), args);
    }
    ...
    public void testNestedLoopSimple() throws Exception {
        ...
        logger.stop();
        assertEquals("You aren't reading as many pages as you need to", 5, logger.getPageAccesses());
    }
    ...
    public void testNestedLoopComplex() throws Exception {
        ...
        logger.stop();
        assertEquals("You aren't reading as many pages as you need to", 11040, logger.getPageAccesses());
    }
